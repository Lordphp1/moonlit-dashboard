...
function updateCategory($conn, $id, $name, $slug, $status) {
    $sql = "UPDATE ".CAT." SET category_name=?, category_unique_id=?, status=?, updated_at=NOW() WHERE category_id=?";
    $stmt = mysqli_prepare($conn, $sql);
