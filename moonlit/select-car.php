          ...
          <?php if (!empty($cars)): ?>
            <?php foreach ($cars as $car): ?>
              <div class="col-md-4 col-sm-6 mb-4" 
                   data-carid="<?php echo htmlspecialchars($car['car_id']); ?>"
                   data-carname="<?php echo htmlspecialchars($car['car_name']); ?>"
                ...
                <div class="ob-car-card">
                  ...
                  <img src="assets/images/<?php echo htmlspecialchars($car['img_url']); ?>" 
                       alt="<?php echo htmlspecialchars($car['car_name']); ?>" 
                       class="img-fluid">
                  <h5 class="ob-car-name"><?php echo htmlspecialchars($car['car_name']); ?></h5>
                </div>
              </div>
            <?php endforeach; ?>
          <?php else: ?>
