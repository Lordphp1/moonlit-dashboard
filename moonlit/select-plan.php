      ...
      <?php if (!empty($plans)): ?>
        ...
        ?>
          ...
          <div class="col-md-3 col-sm-6 mb-4 plan-card-wrap" 
               ...
               data-plan-description="<?php echo htmlspecialchars(strip_tags($plan['product_description'])); ?>">
            
            <div class="ob-plan-card <?php echo $borderClass; ?>">
              <span class="ob-plan-name">
                <?php echo htmlspecialchars($plan['product_name']); ?><br/>
                <b class="ob-section-title">  <?php echo htmlspecialchars($planLabel); ?></b>
              </span>
